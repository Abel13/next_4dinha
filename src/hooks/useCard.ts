import { Card, CardSuit, CardPower, CardSymbol } from "@/models/Card";

const cards: Card[] = [
  {
    id: 0,
    power: CardPower.Hide,
    suit: CardSuit.Hide,
    symbol: CardSymbol.Hide,
    isTrump: false,
  },
  {
    id: 1,
